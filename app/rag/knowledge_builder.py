...
def build_knowledge_base(raw_dir: Path, knowledge_base_dir: Path) -> list[Path]:
    """将原始事件流数据构建为可检索知识库文档。"""

    raw_items = _load_raw_items(raw_dir)
...
def _load_raw_items(raw_dir: Path) -> list[RawKnowledgeItem]:
